...
STM32_Programmer_CLI.exe -c port=COM5 -e 0 -w %~dp0\Bootloader_STM32F103CBT6\Debug\Bootloader_STM32F103CBT6.bin 0x08000000 -w %~dp0\BadiApp_STM32F103CBT6\Debug\BadiApp_STM32F103CBT6.bin 0x08005000
